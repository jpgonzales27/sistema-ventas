                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <h5 class="mb-0">
                                <i
                                    class="fas fa-shopping-bag text-primary me-2"
                                ></i>
                                Gestión de Compras
                            </h5>
                            <small class="text-muted"
                                >Administra las órdenes de compra a
                                proveedores</small
                            >
                        </div>
                        <div class="col-md-8">
                    ...
                    <form @submit.prevent="guardarCompra">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-light">
                                <h6 class="mb-0">
                                    <i class="fas fa-truck me-2"></i>Datos de la
                                    Compra
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        >
                                            Crédito disponible: ${{
                                                proveedorSeleccionado.credito_disponible?.toLocaleString()
                                            }}
                                            | Días crédito:
                                            {{
                                                proveedorSeleccionado.dias_credito
                                            }}
                                        </small>
                                    </div>
                                    ...
                                    <div
                                        class="col-md-3 mb-3"
                                        v-show="
                                            formulario.tipo_compra === 'Credito'
                                        "
                                    >
                                        <label class="form-label"
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            v-model="
                                                formulario.porcentaje_impuesto
                                            "
                                            placeholder="0"
                                            min="0"
                                            max="100"
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            v-model="
                                                formulario.porcentaje_descuento
                                            "
                                            placeholder="0"
                                            min="0"
                                            max="100"
                        ...
                        <div class="card mb-4">
                            ...
                            >
                                <h6 class="mb-0">
                                    <i class="fas fa-boxes me-2"></i>Detalle de
                                    Productos
                                </h6>
                                <button
                                    type="button"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <p>
                                    ...
                                    {{ compraDetalle.codigo }}
                                </p>
                                <p>
                                    <strong>Proveedor:</strong>
                                    {{
                                        compraDetalle.proveedor?.persona
                                            ?.razon_social ||
                                        compraDetalle.proveedor?.persona
                                            ?.nombres
                                    }}
                                ...
                                <p>
                                    <strong>Fecha:</strong>
                                    {{ formatDate(compraDetalle.fecha_compra) }}
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p>
                                    <strong>Tipo:</strong>
                                    {{ compraDetalle.tipo_compra }}
                                </p>
                                <p>
                                    <strong>Comprobante:</strong>
                                    {{ compraDetalle.tipo_comprobante }}
                                    {{ compraDetalle.numero_comprobante }}
                                </p>
                                <p>
...
const proveedorSeleccionado = computed(() => {
    ...
    return proveedores.value.find(
        (p) => p.id === formulario.value.proveedor_id,
    );
});
    ...
    try {
        ...
        if (response.data.success) {
            ...
            formulario.value = {
                ...
                porcentaje_impuesto:
                    parseFloat(compra.porcentaje_impuesto) || 0,
                porcentaje_descuento:
                    parseFloat(compra.porcentaje_descuento) || 0,
                ...
                detalles: compra.detalles.map((d) => ({
                    ...
                    porcentaje_descuento:
                        parseFloat(d.porcentaje_descuento) || 0,
        ...
        Swal.fire({
            ...
            title: "Error",
            text:
                error.response?.data?.message || "No se pudo cargar la compra",
        });
    }
};
...
const onProveedorChange = () => {
    ...
    if (
        ...
        proveedorSeleccionado.value.dias_credito > 0 &&
        formulario.value.tipo_compra === "Credito"
    ) {
        const fechaCompra = new Date(formulario.value.fecha_compra);
        fechaCompra.setDate(
            fechaCompra.getDate() + proveedorSeleccionado.value.dias_credito,
        );
        formulario.value.fecha_vencimiento = fechaCompra
            .toISOString()
            .split("T")[0];
    }
};
...
const calcularTotales = () => {
    ...
    totales.subtotal = formulario.value.detalles.reduce(
    ...
    // Descuento general
    totales.descuento =
        totales.subtotal * (formulario.value.porcentaje_descuento / 100);
    ...
    // Impuesto
    totales.impuesto =
        baseImponible * (formulario.value.porcentaje_impuesto / 100);
