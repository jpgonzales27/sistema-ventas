        ...
        >
            ...
            >
                <div class="footer-copyright">
                    <i class="far fa-copyright"></i> 2024 Sistema de Ventas.
                    Todos los derechos reservados.
                </div>
                <div class="footer-links">
                    <a href="#"
                        ><i class="fas fa-question-circle me-1"></i> Ayuda</a
                    >
                    <a href="#"
                        ><i class="fas fa-book me-1"></i> Documentación</a
                    >
                    <a href="#"><i class="fas fa-envelope me-1"></i> Soporte</a>
                </div>
            </footer>
        </div>
        <!-- End of authenticated-layout -->
    </div>
</template>
    ...
    $.ajaxSetup({
        beforeSend: function (xhr, settings) {
            ...
            if (
                ...
                settings.url.includes(window.location.hostname)
            ) {
